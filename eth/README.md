...
forge script --chain ${DEPLOY_CONFIG} --rpc-url ${RPC_POLYGON_AMOY} --private-key ${PRIVATE_KEY} --broadcast script/DeployMockVerifier.s.sol:DeployMockVerifier
forge script --chain ${DEPLOY_CONFIG} --rpc-url ${RPC_POLYGON_AMOY} --private-key ${PRIVATE_KEY} --broadcast script/DeployCreate2.s.sol:DeployCreate2Deployer
forge script --chain ${DEPLOY_CONFIG} --rpc-url ${RPC_POLYGON_AMOY} --private-key ${PRIVATE_KEY} --broadcast ./script/BridgeDeploy.s.sol:BridgeDeployScript
forge script --chain ${DEPLOY_CONFIG} --rpc-url ${RPC_POLYGON_AMOY} --private-key ${PRIVATE_KEY} --broadcast script/HandlerDeploy.s.sol:HandlerDeployScript
forge script --chain ${DEPLOY_CONFIG} --rpc-url ${RPC_POLYGON_AMOY} --private-key ${PRIVATE_KEY} --broadcast script/DeployTestToken.s.sol:DeployTestToken
```

### Contracts Verification
```shell
forge verify-contract 0x35e3c3be8065bae59e58f9d3182af1a333df0e0e \
  ./script/utils/Create2Deployer.sol:Create2Deployer \
  --chain ${DEPLOY_CONFIG} \
  --verifier etherscan \
  --verifier-url https://api-amoy.polygonscan.com/api \
  --verifier-api-key ${POLYGON_MAINNET_KEY} \
  --constructor-args "0x"


forge verify-contract 0x6263c9d535ac76c538c95017b5d686a2741130cc \
...
forge verify-contract 0x8f81300d6b6bdbed38a38c531a9aab1edea90039 \
...
$ cast calldata "function initialize(address,address,address)" "0x3fcbaf4822e7c7364e43aec8253dfc888b9235bb" "0x3fcbaf4822e7c7364e43aec8253dfc888b9235bb" "0x6263c9d535ac76c538c95017b5d686a2741130cc" 
...
$ forge verify-contract 0xa88c1c777a056510331325dfad71140320dd8865 \
...
forge verify-contract 0x48d4c20ce517a007d1c7fae52b4562a7d7fadead \
 ...
 --chain ${DEPLOY_CONFIG} \
  ...
  # verify test token
  forge verify-contract 0x01Fba73c837a0003e008c28Fc8120084C1241266 \
